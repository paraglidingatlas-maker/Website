...
<footer>
  ...
  <div class="footer-top">
    ...
    <div class="footer-col">
      ...
      <a href="../destinations/india.html">India Tour</a>
    ...
    <div class="footer-col">
      ...
      <a href="../partners.html">Partner With Me</a>
    </div>
    <div class="footer-col">
      <h2>Legal</h2>
...
subseries_page(
    ...
    [
        ...
        {"title": "From Cuba to Socotra: Inside the World's Most Unique Paragliding Tours", "guest": "Chris Garcia"},
...
subseries_page(
    ...
    [
        ...
        {"title": "Metacognition: Paragliding's Hidden Psychology", "guest": "Beni Kälin & Heli Schrempf"},
        {"title": "Cognitive Bias of Dunning Kruger Effect in Paragliding", "guest": "Beni Kälin & Heli Schrempf"},
