...
- **Eight redirect stubs** (27 since 21 Sept 2026, when the old site's nested
  `/knowledge-base/<category>/<series>` paths were added) from old site URLs, generated by
...
### The 27 redirect stubs correctly have NO footer
