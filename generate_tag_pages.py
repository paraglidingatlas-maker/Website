...
<footer>
  ...
  <div class="footer-top">
    <div class="footer-col footer-brand">
      <a href="{root}index.html" class="wordmark" aria-label="Paragliding Atlas, home"><img src="{root}assets/logo/atlas-logo-white.png" alt="Paragliding Atlas" class="logo-img" loading="lazy"></a>
