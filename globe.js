...
(function () {
  ...
  const episodeData = [
    ...
    ['The Russell Ogden Interview: Decoding The Paragliding Mastery Protocol', 'episodes/the-russell-ogden-interview-decoding-paragliding-mastery.html', -1.9, 52.5],
    ['Paragliding Physiology & Safety Protocols — Dr Matt Wikes Explains Biophysics in the Art of Flight', 'episodes/paragliding-physiology-safety-protocols-dr-matt-wilkes.html', -1.5, 52.0],
    ['If You Fly in the Himalayas, Alps, or Above 3000mtrs, This Episode Is For You — ft. Dr Matt Wikes', 'episodes/if-you-fly-in-the-himalayas-alps-or-above-3000-mtrs-this.html', 76.7, 32.0],
    ['Cognitive Bias of Dunning Kruger Effect in Paragliding — Beni Kalin & Heli Schrempf', 'episodes/cognitive-bias-of-dunning-kruger-effect-in-paragliding.html', 13.4, 47.3],
    ...
    ['Survived 15 Years of Flying Then a Rescue Helicopter Changed Everything — A Talk With Nick Neynens', 'episodes/survived-15-years-of-flying-then-a-rescue-helicopter.html', 4.35, 50.85],
    ...
    ["The Art of Capturing Human Flight — Jake Holland's Guide to Filming Passion Projects", 'episodes/the-art-of-capturing-human-flight-jake-holland-s-guide-to.html', -2.5, 53.4],
    ["Master the Art of Scoring in Paragliding: A New Pilot's Guide to the GAP Formula & Strategy — Joerg Ewald", 'episodes/scoring-in-paragliding-competitions-a-new-pilot-s-guide-to.html', 10.4, 51.2],
    ...
    ['The Unfiltered Truth About Paragliding Governance — Bill Hughes & Goran Dimiskovski', 'episodes/the-unfiltered-truth-about-paragliding-governance-with.html', 21.7, 41.6],
    ...
    ['#CIVLRESIGN with Julien Garcia', 'episodes/what-is-civlresign-with-julien-garcia.html', 2.35, 48.85],
    ...
    ['Maxime Pinot: The Journey Within — Mapping Our Quest to Touch The Sky With Glory', 'https://creators.spotify.com/pod/profile/paragliding-atlas/episodes/Maxime-Pinot--The-Journey-Within--Mapping-our-Quest-to-Touch-The-Sky-With-Glory-e369o9u/a-ac3363u', 6.13, 45.9],
    ["Understanding Skymate: Paragliding World's First AI Powered Smart Harness System with Roman Barthelemy", 'episodes/understanding-skymate-paragliding-worlds-first-ai-driven.html', 2.35, 48.85],
    ['Science Backed Pre Flight Rituals to Unlock Laser Sharp Paragliding Clarity: On Demand', showUrl, 10.75, 59.91],
    ["The Resilience Equation: Erlend Ukvitne's Unrelenting Path to X-Alps and the Brink of a Hike and Fly World Record", 'episodes/the-resilience-equation-erlend-ukvitnes-unrelenting-path.html', 8.5, 60.5],
    ...
    ['Grant Smith: The Silent Mind In Screaming Winds — Unlocking Peak Focus To Attain Flow State In Paragliding', 'episodes/the-silent-mind-in-screaming-winds-unlocking-peak-focus-to.html', -1.9, 52.5],
    ...
    ['Helmet Safety: Christian Ciech — ICARO 2000 [1st Anniversary Edition]', 'episodes/helmet-safety-christian-ciech-icaro-2000.html', 12.5, 41.9],
